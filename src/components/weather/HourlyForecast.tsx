                ...
                >
                  ...
                  <div className="my-3 flex justify-center">
                    <div className="relative">
                      {hour.condition?.icon ? (
                        <ImageLoader 
                          src={hour.condition.icon.startsWith('http') ? hour.condition.icon : `https:${hour.condition.icon}`}
                        ...
                        <div className="w-10 h-10 flex items-center justify-center bg-gray-200/30 dark:bg-gray-700/30 rounded-full">
